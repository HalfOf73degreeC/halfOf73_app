...
public class MapActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener {
    ...
    private List<FoundationBean_HO73> foundationList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (googleServicesAvailable()) {
            ...
            FoundationDao foundationDao = new FoundationDao(MapActivity.this);
            foundationList = foundationDao.getStoreByDistance();
            initMap();
            handViews();
...
//            getSupportActionBar().setDisplayHomeAsUpEnabled(true);
    ...
    private void handViews() {
        ...
        foundationList = getFoundationList();
        recyclerView.setAdapter(new storeInfoAdapter(this,foundationList));
        /* 不處理捲動事件所以監聽器設為null */
    ...
    private class storeInfoAdapter extends RecyclerView.Adapter<storeInfoAdapter.mViewHolder> {
        ...
        private List<FoundationBean_HO73> storeInfoList;

        storeInfoAdapter(Context context,List<FoundationBean_HO73> storeInfoList){
        ...
        public void onBindViewHolder(@NonNull final mViewHolder holder, final int position) {
            final FoundationBean_HO73 fb = storeInfoList.get(position);
            holder.imageView.setImageResource(R.drawable.basketball);
            holder.tvName.setText(fb.getFunName());
           // holder.tvaddress.setText("123");
        ...
        googleMap.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(Marker marker) {
                ...
                for(int i =0;i< foundationList.size();i++) {
                    if(markerPosition.latitude == foundationList.get(i).getFunLat() && markerPosition.longitude == foundationList.get(i).getFunLng()) {
                        selectMarker = i;
                    }
                }
    ...
    private void makeMarkers() {
        List<FoundationBean_HO73> markers = getFoundationList();
        Bitmap smallMarker = smallMarker();
        //MapMarker
        for(int i=0;i<markers.size();i++) {
            Store_Marker = mgoogleMap.addMarker(new MarkerOptions()
                    .position(new LatLng(markers.get(i).getFunLat(),markers.get(i).getFunLng()))
                    .icon(BitmapDescriptorFactory.fromBitmap(smallMarker)));
        }
        defaultMarker = mgoogleMap.addMarker(new MarkerOptions()
                .position(new LatLng(markers.get(0).getFunLat(),markers.get(0).getFunLng()))
    ...
    private void recyclePosition(int position,Marker marker){
        ...
        markerPosition  = new LatLng(foundationList.get(scrollPosition).getFunLat(),foundationList.get(scrollPosition).getFunLng());
        ...
        double lat = foundationList.get(position).getFunLat();
        double lon = foundationList.get(position).getFunLng();
        setLocation(lat,lon);
    }

    //StoreInfoList
    public List<FoundationBean_HO73> getFoundationList() {
//        List<FoundationBean_HO73> foundationList = new ArrayList<>();
//        FoundationDao foundationDao = new FoundationDao(MapActivity.this);
//        foundationList = foundationDao.getStoreByDistance();
//        StoreInfoList.add(new StoreInfo(0, R.drawable.basketball,"XXX甜點","dsfdfdsfdjfoie wfjhnvujdhhencvjvkjnjsbkjdbvghkj hvofj o",25.042685,121.539954));
//        StoreInfoList.add(new StoreInfo(1,R.drawable.basketball,"XXX甜點","dsfdfdsfdjfoie wfjhnvujdhhencvjvkjnjsbkjdbvghkj hvofj o",25.040197,121.535736));
//        StoreInfoList.add(new StoreInfo(2,R.drawable.basketball,"XXX甜點","dsfdfdsfdjfoie wfjhnvujdhhencvjvkjnjsbkjdbvghkj hvofj o",25.041201,121.531548));
//        StoreInfoList.add(new StoreInfo(3,R.drawable.basketball,"XXX甜點","dsfdfdsfdjfoie wfjhnvujdhhencvjvkjnjsbkjdbvghkj hvofj o",25.04380758,121.53599093));
//        StoreInfoList.add(new StoreInfo(4,R.drawable.basketball,"XXX甜點","dsfdfdsfdjfoie wfjhnvujdhhencvjvkjnjsbkjdbvghkj hvofj o",25.04417695,121.53433869));
//        StoreInfoList.add(new StoreInfo(5,R.drawable.basketball,"XXX甜點","dsfdfdsfdjfoie wfjhnvujdhhencvjvkjnjsbkjdbvghkj hvofj o",25.04061933,121.53543303));
//        StoreInfoList.add(new StoreInfo(6,R.drawable.basketball,"XXX甜點","dsfdfdsfdjfoie wfjhnvujdhhencvjvkjnjsbkjdbvghkj hvofj o",25.04281612,121.53886626));
//        StoreInfoList.add(new StoreInfo(7,R.drawable.basketball,"XXX甜點","dsfdfdsfdjfoie wfjhnvujdhhencvjvkjnjsbkjdbvghkj hvofj o",25.04629592,121.53508562));
//        StoreInfoList.add(new StoreInfo(8,R.drawable.basketball,"XXX甜點","dsfdfdsfdjfoie wfjhnvujdhhencvjvkjnjsbkjdbvghkj hvofj o",25.04240787,121.53021473));
//        StoreInfoList.add(new StoreInfo(9,R.drawable.basketball,"XXX甜點","dsfdfdsfdjfoie wfjhnvujdhhencvjvkjnjsbkjdbvghkj hvofj o",25.04011386,121.536463));
//        StoreInfoList.add(new StoreInfo(10,R.drawable.basketball,"XXX甜點","dsfdfdsfdjfoie wfjhnvujdhhencvjvkjnjsbkjdbvghkj hvofj o",25.03844193,121.53856585));
